...
int pyramidFunction() {
  ...
  } else if (int parameter == "output") {

    digitalWrite(lampPin, HIGH);
    delay(1000);
    break;
  } else if (int parameter == "both") {
...
int ballFunction(int parameter) {
...
void loop(){
 ...
 if (code == "pyramid1+pyramid2+pyramid3") {
   ...
   boxFunction();
 } else if (code == "ball1+ball2+ball3"){
  ballFunction("both");
