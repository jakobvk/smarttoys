int trigger=23; //Trigger-Pin des Ultraschallsensors an Pin7 des Arduino-Boards
int echo=32; // Echo-Pim des Ultraschallsensors an Pin6 des Arduino-Boards
int lamp = 12;
...
Serial.println(entfernung); //dann soll der serial monitor ausgeben „Kein Messwert“, weil Messwerte in diesen Bereichen falsch oder ungenau sind.
